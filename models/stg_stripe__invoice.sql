...
final as (
    ...
    select 
        ...
        payment_intent_id,
        subscription_id,
        {{ convert_values('amount_due') }},
        {{ convert_values('amount_paid') }},
        {{ convert_values('amount_remaining') }},
        {{ convert_values('post_payment_credit_notes_amount') }},
        {{ convert_values('pre_payment_credit_notes_amount') }},
