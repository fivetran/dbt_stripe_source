...
{% set columns = [
    ...
    {"name": "metadata_netsuite_auto_apply", "datatype": "boolean"},
    {"name": "metadata_netsuite_customer_id", "datatype": dbt_utils.type_int()},
    {"name": "metadata_netsuite_customer_payment_id", "datatype": dbt_utils.type_int()},
    {"name": "metadata_netsuite_customer_payment_link", "datatype": dbt_utils.type_string()},
    {"name": "metadata_netsuite_invoice_id", "datatype": dbt_utils.type_int()},
    {"name": "metadata_netsuite_payment_from_customer_portal", "datatype": "boolean"},
