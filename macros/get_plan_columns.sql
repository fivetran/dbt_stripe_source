...
{% set columns = [
    ...
    {"name": "interval", "datatype": dbt_utils.type_string()},
    ...
    {"name": "metadata_netsuite_service_sale_item_id", "datatype": dbt_utils.type_int()},
    {"name": "metadata_netsuite_service_sale_item_link", "datatype": dbt_utils.type_string()},
