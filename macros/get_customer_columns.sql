...
{% set columns = [
    ...
    {"name": "metadata_fivetran_account_id", "datatype": dbt_utils.type_string()},
    {"name": "metadata_fivetran_account_name", "datatype": dbt_utils.type_string()},
    {"name": "metadata_netsuite_block_integration", "datatype": "boolean"},
    {"name": "metadata_netsuite_customer_id", "datatype": dbt_utils.type_int()},
    {"name": "metadata_netsuite_customer_link", "datatype": dbt_utils.type_string()},
    {"name": "metadata_netsuite_source", "datatype": dbt_utils.type_string()},
